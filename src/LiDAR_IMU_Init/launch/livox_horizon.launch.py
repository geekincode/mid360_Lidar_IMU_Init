...
def generate_launch_description():
    ...
    rviz_default = os.path.join(pkg, "rviz_cfg", "fast_lo.rviz")
    cfg_default = os.path.join(pkg, "config", "horizon.yaml")
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name="laser_mapping",
            output="screen",
            parameters=[config_file, {"point_filter_num": 3, "max_iteration": 5, "cube_side_length": 2000.0}],
        ),
        Node(
            package="rviz2",
            executable="rviz2",
